...
function buildContextAsymmetric(agentId, profile, job) {
  ...
  if (agentId === "organization") {
    jobBlock = [
      ...
      job.industrySector && `업종: ${job.industrySector}`,
