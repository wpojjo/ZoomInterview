    ...
    <main className="min-h-screen py-8 px-4">
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-50">기본 정보를 입력해주세요</h1>
          <p className="text-sm text-gray-500 dark:text-slate-400">학력, 경력, 자격증, 대외활동 정보를 바탕으로 맞춤 면접 질문을 생성합니다</p>
        </div>
